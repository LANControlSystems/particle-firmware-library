...
MEMFAULT_NO_OPT MEMFAULT_WEAK void user_transport_send_chunk_data(
  MEMFAULT_UNUSED void *chunk_data, MEMFAULT_UNUSED size_t chunk_data_len) { }
...
int memfault_demo_drain_chunk_data(MEMFAULT_UNUSED int argc, MEMFAULT_UNUSED char *argv[]) {
