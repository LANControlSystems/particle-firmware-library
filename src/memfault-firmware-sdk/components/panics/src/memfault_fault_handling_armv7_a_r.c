...
#include "memfault-firmware-sdk/components/include/memfault/core/compiler.h"
  ...
  #include "memfault-firmware-sdk/components/include/memfault/panics/arch/arm/v7_a_r.h"
...
MEMFAULT_NAKED_FUNC void MEMFAULT_EXC_HANDLER_UNDEFINED_INSTRUCTION(void) {
  __asm volatile(
...
MEMFAULT_NAKED_FUNC void MEMFAULT_EXC_HANDLER_DATA_ABORT(void) {
...
MEMFAULT_NAKED_FUNC void MEMFAULT_EXC_HANDLER_PREFETCH_ABORT(void) {
