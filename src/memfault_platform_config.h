...
// Assume target is Device OS 5.9
#define MEMFAULT_PARTICLE_SYSTEM_VERSION 0x05090000
#endif
...
#ifndef MEMFAULT_PLATFORM_COREDUMP_STORAGE_FLASH_SIZE
#define MEMFAULT_PLATFORM_COREDUMP_STORAGE_FLASH_SIZE (5*1024)
#endif
...
#define MEMFAULT_PLATFORM_MAX_TRACKED_TASKS 8
#endif

#ifndef MEMFAULT_PARTICLE_PORT_COREDUMP_MAX_TASK_REGIONS
#define MEMFAULT_PARTICLE_PORT_COREDUMP_MAX_TASK_REGIONS (MEMFAULT_PLATFORM_MAX_TRACKED_TASKS)
#endif
