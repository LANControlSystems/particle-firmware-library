...
#define MEMFAULT_PLATFORM_ACTIVE_STACK_SIZE_TO_COLLECT 1024
#endif
...
#define MEMFAULT_PARTICLE_PORT_COREDUMP_MAX_TASK_REGIONS ((MEMFAULT_PLATFORM_MAX_TRACKED_TASKS)*2)
#endif
